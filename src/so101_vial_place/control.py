...
# Center of the tabletop acquisition region.  The reset generator samples a
# modest rectangle around this point, while the scene default remains useful
# for construction and diagnostics that do not load the reset dataset.
TABLETOP_VIAL_POSITION = (0.231, -0.017, 0.06)
# Half-widths of the acquisition region in world X/Y.  A 60 x 80 mm region is
# large enough to require genuine object-relative reaching without pushing the
# small arm toward the edge of its demonstrated workspace.
