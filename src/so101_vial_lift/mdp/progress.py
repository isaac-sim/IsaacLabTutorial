...
class PlacementProgress:
    ...
    def __init__(self, num_envs: int, device: str | torch.device, stable_steps: int = 15):
    ...
    def update(
        ...
        self.grasped |= bilateral_contact
        ...
        if valid_grasped_placement is not None:
            ...
            self.release_ready |= self.rack_hold_count >= 2
        candidate = self.lifted & valid_released_placement
