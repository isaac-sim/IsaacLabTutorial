...
def residual_post_lift_gate(proprioception: torch.Tensor) -> torch.Tensor:
    ...
    return (proprioception[..., 5:6] < POST_LIFT_GRIPPER_MAX) & (
        proprioception[..., 1:2] > POST_LIFT_SHOULDER_MIN
    )
...
def replacement_post_lift_gate(proprioception: torch.Tensor) -> torch.Tensor:
    ...
    return residual_post_lift_gate(proprioception) & (
        proprioception[..., 3:4] < POST_LIFT_WRIST_MAX
    )
